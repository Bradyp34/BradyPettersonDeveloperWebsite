        ...
        protected override void OnModelCreating (ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<Featuretask>(entity => {
                ...
                entity.HasOne(d => d.Feature)
                      .WithMany(p => p.Featuretasks)
                      .HasConstraintName("featuretask_featureid_fkey");

                entity.HasOne(d => d.Task)
                      .WithMany(p => p.Featuretasks)
                      .HasConstraintName("featuretask_taskid_fkey");
            });
            ...
            modelBuilder.Entity<Projectuser>(entity => {
                ...
                entity.HasOne(d => d.Project)
                      ...
                      .HasConstraintName("projectuser_projectid_fkey");

                entity.HasOne(d => d.User)
                      .WithMany(p => p.Projectusers)
                      .HasConstraintName("projectuser_userid_fkey");
            });
            ...
            modelBuilder.Entity<Taskuser>(entity => {
                ...
                entity.HasOne(d => d.Task)
                      ...
                      .HasConstraintName("taskuser_taskid_fkey");

                entity.HasOne(d => d.User)
                      .WithMany(p => p.Taskusers)
                      .HasConstraintName("taskuser_userid_fkey");
            });
